...
public class TranslatorUtil {
    ...
    public static final String FAILED_TO_INITIALIZE_STT_ENGINE = "Sorry! Your device doesn\'t support speech input";
    public static final String FAILED_TO_INITILIZE_TTS_ENGINE = "Failed to initilize TTS engine";
