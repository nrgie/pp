package com.blueobject.peripatosapp.ui.animation;
...
import com.blueobject.peripatosapp.ui.interfaces.GuillotineListener;
import com.blueobject.peripatosapp.ui.util.ActionBarInterpolator;
import com.blueobject.peripatosapp.ui.util.GuillotineInterpolator;
...
public class GuillotineAnimation {
    ...
    private static final float ACTION_BAR_ROTATION_ANGLE = 1f;
    ...
    public static class GuillotineBuilder {
        ...
        public GuillotineBuilder(View guillotineView, View menu) {
            this.guillotineView = guillotineView;
            this.openingView = menu;
            this.closingView = menu;
        }
