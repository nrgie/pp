package com.blueobject.peripatosapp.ui.util;
...
public class CustomSuggestionsAdapter extends SuggestionsAdapter<Tours.TourItem, CustomSuggestionsAdapter.SuggestionHolder> {
    ...
    @Override
    public void onBindSuggestionHolder(Tours.TourItem suggestion, SuggestionHolder holder, int position) {
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if(term.isEmpty())
                    ...
                    for (Tours.TourItem item: suggestions_clone)
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                suggestions = (ArrayList<Tours.TourItem>) results.values;
