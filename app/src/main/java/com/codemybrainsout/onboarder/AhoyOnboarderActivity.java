...
public abstract class AhoyOnboarderActivity extends AppCompatActivity implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    private RelativeLayout tosbox;
    private AppCompatCheckBox tos;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tosbox = (RelativeLayout) findViewById(R.id.tosbox);
        tos = (AppCompatCheckBox) findViewById(R.id.tos);
        tostext = (TextView) findViewById(R.id.tostext);
        ...
        tostext.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.tostext) {
            ...
            View alertDialogView = inflater.inflate(R.layout.tos_dialog, null);
            WebView myWebView = alertDialogView.findViewById(R.id.DialogWebView);
            myWebView.setWebViewClient(new WebViewClient());
            myWebView.loadUrl("http://peripatos-app.com/terms.html");
        ...
        if (i == R.id.btn_skip && isInLastPage) {
            ...
            if(tos.isChecked()) {
                ...
                builder.setMessage("Please accept terms and conditions for using Peripatos");
...
AlertDialog alert = builder.show();
    ...
    * */
    ...
    private void showFinish() {
        ...
        // ide a show pipa és a terms popup.

        tosbox.setVisibility(View.VISIBLE);
    ...
    private void hideFinish(boolean delay) {
        ...
        tosbox.setVisibility(View.GONE);
